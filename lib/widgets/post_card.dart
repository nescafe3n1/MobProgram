              ...
              children: [
                ...
                if (widget.hasImage && widget.postImage != null)
                  Padding(
                    ...
                    child: Image.asset(widget.postImage!, width: double.infinity, fit: BoxFit.cover),
                  ),
              ],
            ),
          ),
            ...
            child: Row(
              ...
              children: [
                TextButton.icon(
                  ...
                  icon: Icon(isLiked ? Icons.thumb_up : Icons.thumb_up_alt_outlined, size: 20.sp, color: customActionColor),
                  label: CustomFont(text: currentLikes.toString(), fontSize: 13.sp, fontWeight: FontWeight.w600, color: customActionColor),
                ),
                _buildStaticButton(Icons.chat_bubble_outline, "Comment", customActionColor),
                _buildStaticButton(Icons.reply, "Share", customActionColor, isFlipped: true),
              ],
            ),
          ),
        ],
  ...
  Widget _buildStaticButton(IconData icon, String label, Color color, {bool isFlipped = false}) {
    return Row(
      children: [
        ...
        SizedBox(width: 8.w),
        CustomFont(text: label, fontSize: 13.sp, fontWeight: FontWeight.w600, color: color),
      ],
    );
  }
}